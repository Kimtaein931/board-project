...
public class PageMakerDTO {
	...
	public PageMakerDTO(Criteria cri, int total) {
		...
		/* 
		 * 작성한 생성자에선 다음의 순서대로 값들을 계산하여 각 변수를 초기화하게 된다.
		 * 
		 * 화면에 보일 마지막 페이지 -> 화면에 보여질 시작 페이지 -> 전체 마지막 페이지 계산 -> 화면에 보여질 마지막 페이지 유효성 체크 ->
		 * 화면에 보여질 페이지 이전 페이지 존재 여부 -> 화면에 보여질 페이지의 다음 페이지 존재 여부
		 * */
	}
